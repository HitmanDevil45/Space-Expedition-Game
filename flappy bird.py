...
BACKGROUND = 'gallery/sprites/space.gif'
PIPE = 'gallery/sprites/laser.png'
    ...
    while True:
        for event in pygame.event.get():
            ...
            # If the user presses space or up key, start the game for them
                ...
                SCREEN.blit(GAME_SPRITES['background'], (4, 0))
...
def mainGame():
    ...
    playerFlapped = False  # It is true only when the bird is moviing
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Space expidition')
    ...
    GAME_SPRITES['message'] = pygame.image.load(
        'gallery/sprites/123.png').convert_alpha()
